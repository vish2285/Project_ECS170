...
train_data.dataset_source_file_name = 'MNIST'
train_data.dataset_type = 'MNIST'
train_data.split = 'train'

test_data = Dataset_Loader('MNIST-test', '')
test_data.dataset_source_folder_path = DATA_PATH
test_data.dataset_source_file_name = 'MNIST'
test_data.dataset_type = 'MNIST'
test_data.split = 'test'

method_obj = Method_CNN('CNN-MNIST', '')
method_obj.dataset_type = 'MNIST'
...
result_obj.result_destination_file_name = 'MNIST_CNN_prediction_result'
